...
- **IAudioMixerPlatformInterface**
	...
	![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image.png>)
    
- **Audio::FOutputBuffer OutputBuffer**  在 IAudioMixerPlatformInterface  FRunable 线程中

![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%201.png>)
...
![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%202.png>)
...
![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%203.png>)

不过当前从CallStack 上来看，IOS 用的应该也是FMixerDevice，然后平台层去写相关资源取用实现

补充一下AudioDevice 初始化时候

![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%204.png>)
...
![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%205.png>)

而 PumpCommandQueue 主要是在 FlushCommandQueue 的时候

![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%206.png>)

![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%207.png>)

## 音频线程中 影响`CommandsProcessedEvent` 的 AudioRenderEvent

### 两者的联系

![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%208.png>)
...
![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%209.png>)

![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%2010.png>)
...
![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%2011.png>)

IOS Audio Unit 这边调用：

![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%2012.png>)
...
![image.png](<./Unreal Engine 音频渲染 - 以 IOS 为例 源码分析.assets/image%2013.png>)
